...
# David Valpey's custom stemming transformer class for pyspark
class StemmingTransformer(Transformer, HasInputCol, HasOutputCol):
    @keyword_only
    ...
    def _transform(self, dataset):
        ...
        udfStemmer = udf(lambda tokens: [opinion_stemm.stem(word)
                                         for word in tokens], ArrayType(StringType()))
